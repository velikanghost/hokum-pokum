...
export const HeroSection = () => {
  return (
    <section className="relative h-[100dvh] md:h-[88dvh]">
      ...
      <div className="hero_wrapper h-full w-full rounded-[4px] md:rounded-xl"></div>
      <div className="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="grid place-items-center">
          <h1 className="text-secondary-foreground drop-shadow-sm text-[45px] md:text-[70px] leading-[120%] text-center font-headings font-bold mb-6">
